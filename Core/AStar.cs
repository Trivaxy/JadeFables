using ReLogic.Content;//credit to https://github.com/davecusatis/A-Star-Sharp
using System;
...
{
    public delegate bool ClearTile(int x, int y);

    public class Node //credit to https://github.com/davecusatis/A-Star-Sharp
    {
