...
namespace JadeFables.Tiles.JadePylon
{
    ...
    /// </br>
    /// </summary>
    public class JadePylonTile : ModPylon
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(Color.LimeGreen, pylonName);
            DustType = -1;
        }
        ...
        public override NPCShop.Entry GetNPCShopEntry()
        {
            ...
            return new NPCShop.Entry(ModContent.ItemType<JadePylonItem>(), Condition.AnotherTownNPCNearby, cond);
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            Main.LocalPlayer.cursorItemIconID = ModContent.ItemType<JadePylonItem>();
        }
        ...
        public override void SpecialDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            DefaultDrawPylonCrystal(spriteBatch, i, j, crystalTexture, crystalHighlightTexture, new Vector2(0f, -12f), Color.LimeGreen * 0.1f, Color.LimeGreen, 6, CrystalVerticalFrameCount);
        }
        ...
        public override void DrawMapIcon(ref MapOverlayDrawContext context, ref string mouseOverText, TeleportPylonInfo pylonInfo, bool isNearPylon, Color drawColor, float deselectedScale, float selectedScale)
        {
            ...
            DefaultMapClickHandle(mouseOver, pylonInfo, ModContent.GetInstance<JadePylonItem>().DisplayName.Key, ref mouseOverText);
        }
    }
    public class JadePylonItem : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Jade Pylon");
        ...
        {
            Item.DefaultToPlaceableTile(ModContent.TileType<JadePylonTile>());
