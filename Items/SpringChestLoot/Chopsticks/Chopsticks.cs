    ...
    public class ChopstickProj : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (swordTexture == null)
                return false;
            Main.spriteBatch.Draw(swordTexture, Projectile.Center + new Vector2(0, Owner.gfxOffY) + (29 * Projectile.rotation.ToRotationVector2()) - Main.screenPosition, null, item.GetAlpha(lightColor), (Projectile.rotation + 0.78f) + (Owner.direction == 1 ? 0f : 1.57f), new Vector2(Owner.direction == 1 ? 0 : swordTexture.Width, swordTexture.Height), Projectile.scale * itemScale, Owner.direction == -1 ? SpriteEffects.FlipHorizontally : SpriteEffects.None, 0f);
