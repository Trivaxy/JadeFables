using JadeFables.Configs;
using JadeFables.Core.Systems.ScreenTargetSystem;
using JadeFables.Helpers;
using Terraria.Graphics.Effects;
using static JadeFables.Helpers.DrawHelper;

namespace JadeFables.Core.Systems.LightingSystem
{
